...
<p>  
    ...
    <tr>
      ...
      <td><a title="Descargar Archivo" href="descargar.php?Descargar=subidas/<?php echo $archivos[$i]; ?>" download="descargar.php?Descargar=subidas/<?php echo $archivos[$i]; ?>" style="color: blue; font-size:18px;"> <span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span> </a></td>
